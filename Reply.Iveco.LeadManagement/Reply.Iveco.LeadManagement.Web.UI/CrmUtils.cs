...
namespace Reply.Iveco.LeadManagement.Presenter.Model
{
    public class CrmUtils
    {
        ...
        public CrmUtils(ICrmService crmService)
        {
        ...
        public bool UserHasRole(Guid userId, string roleName)
        {
            ...
            BusinessEntity ruolo = user_roles.Find(UserRole => ((role)UserRole).name.ToUpper(CultureInfo.InvariantCulture).Equals(roleName.ToUpper(CultureInfo.InvariantCulture)));
            return (ruolo != null);
        }
